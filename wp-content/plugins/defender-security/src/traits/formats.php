...
trait Formats {
	...
	public function time_since( $since ): string {
		...
		$chunks = [
			[ 60 * 60 * 24 * 365, esc_html__( 'year', 'defender-security' ) ],
			[ 60 * 60 * 24 * 30, esc_html__( 'month', 'defender-security' ) ],
			[ 60 * 60 * 24 * 7, esc_html__( 'week', 'defender-security' ) ],
			[ 60 * 60 * 24, esc_html__( 'day', 'defender-security' ) ],
			[ 60 * 60, esc_html__( 'hour', 'defender-security' ) ],
			[ 60, esc_html__( 'minute', 'defender-security' ) ],
			[ 1, esc_html__( 'second', 'defender-security' ) ],
		];
	...
	public function get_date( $date ) {
		if ( strtotime( '-24 hours' ) > $date ) {
			...
			return human_time_diff( $date, time() ) . ' ' . __( 'ago', 'defender-security' ); // phpcs:ignore
		}
	}
