...
class PHP_Version extends Component {
	...
	public function to_array(): array {
		...
		return [
			'slug' => $this->slug,
			'title' => __( 'Update PHP to latest version', 'defender-security' ),
			'errorReason' => sprintf( __( "PHP versions older than %s are no longer supported. For security and stability we strongly recommend you upgrade your PHP version to version %s or newer as soon as possible.", 'defender-security' ), $this->min_php, $this->min_php ),
			'successReason' => __( 'You have the latest version of PHP installed, good stuff!', 'defender-security' ),
			'misc' => [
