...
if ( ! class_exists( 'Mo2f_Setup_Wizard' ) ) {
	...
	class Mo2f_Setup_Wizard {
		...
		/**
		 * Call header and footer and content functions and scripts
		 *
		 * @return void
		 */
		 ...
		 *
		 * @param boolean $setup_wizard show steps based on  value.
		 * @return void
		 */
		public function mo2f_congratulations_step( $setup_wizard ) {
			if ( $setup_wizard ) {
