<?php
/**
 * This file is used to display session restriction feature.
 *
...
<div>
	...
	<div class="mo2f_table_layout" style="background-color: aliceblue; border:none;">
			...
			Disable access
			<br><br>
			<div class="mo2f_advanced_options_note" style="background-color: #bfe5e9;padding:12px"><b>Note:</b><?php esc_html_e( ' All other sessions would be destroyed except for the current session after saving the settings', 'miniorange-2-factor-authentication' ); ?>.</div>
			<br><br>	
			<label >
